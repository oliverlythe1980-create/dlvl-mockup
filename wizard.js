...
(function () {
  ...
  const T = ES ? {
    ...
    note_rusty: '¿Hace mucho que no buceas? El refresco ReActivate (IDR 900.000, media jornada) es la vuelta al agua más amable.',
    ...
    note_group: '¿Sois más de cuatro? Nunca bucearéis en manada: montamos guías en paralelo y cerramos la logística por WhatsApp.',
